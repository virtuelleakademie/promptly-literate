...
@bubeckSparksArtificialGeneral2023 give a fascinating summary of tasks that GPT-4 is lcaimed to be capable of.
...
Now use both ChatGPT and the Playground to perform the following tasks:
