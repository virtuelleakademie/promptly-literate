...
- <mark style="background: #EBCB8B;">Each new token is added to the sequence of tokens</mark> that the model uses to predict the next token.
...
and explore this [activity](../pages/activity-1-prompting-techniques.qmd).
