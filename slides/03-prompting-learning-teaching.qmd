...
One setting is focussed on on using LLMs to improve learning [@mollickAssigningAISeven2023b], and the other is focussed on using LLMs for teaching[@mollickUsingAIImplement2023a].
...
- Loo up works related to the concept.
...
Now open the third activity to explore prompting techniques related to learning and teaching: [👉 Activity 3](../pages/activity-3-prompting-learning-teaching.qmd).
