...
Im Playground kannst du den Assistenten so konfigurieren, dass er auf ein PDF zugreift. Per System Message (Instructions) kannst du den Assistenten anweisen, Antworten nur auf Basis der PDFs zu geben. Die _Temperatur_ für die Textgenerierung kannst du hier auch anpassen.
:::
