...
In this activity, you can explore various prompting guides for GPT models. They more or less all converge on the same set of techniques. You can then use these techniques to write your own prompt for a GPT model.

## Tasks

(@) **Explore prompting**. Use both/either ChatGPT and Bing Chat. If you want to look anything up, try these prompting guides:
...
👉 [Prompting guide](https://www.promptingguide.ai/): **DAIR.AI** (Democratizing Artificial Intelligence Research, Education, and Technologies). The guide is licensed under an MIT license.
...
<!-- ```{=html}
<iframe src="https://prompttools.streamlit.app/" width="100%" height="500px"></iframe>
```  -->
:::
...
(@) **Write a prompt** that will make ChatGPT or Bing Chat act as an argumentation critic.
...
If you want help getting started, you can open this conversation in ChatGPT.

:::{.callout-tip collapse="true"}
## Open in ChatGPT

```{=html}
<iframe src="https://chat.openai.com/share/a76bec67-df0d-4914-8cda-54d3ef2380d9" width="100%" height="500px"></iframe>
```
:::
...
(@) **Miro board**: Add your prompt to the [Miro board](https://miro.com/app/board/uXjVNW_AhHc=/?share_link_id=410125738019). You can also open this in [activity 4](activity-4-miro.qmd).
